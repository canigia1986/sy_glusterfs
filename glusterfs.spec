...
# rpmbuild -ta glusterfs-3.6.7.tar.gz --without rdma
...
# rpmbuild -ta glusterfs-3.6.7.tar.gz --without epoll
%{?_without_epoll:%global _without_epoll --disable-epoll}

# if you wish to compile an rpm without fusermount...
# rpmbuild -ta glusterfs-3.6.7.tar.gz --without fusermount
%{?_without_fusermount:%global _without_fusermount --disable-fusermount}

# if you wish to compile an rpm without geo-replication support, compile like this...
# rpmbuild -ta glusterfs-3.6.7.tar.gz --without georeplication
...
# rpmbuild -ta glusterfs-3.6.7.tar.gz --without ocf
%{?_without_ocf:%global _without_ocf --without-ocf}

# if you wish to build rpms without syslog logging, compile like this
# rpmbuild -ta glusterfs-3.6.7.tar.gz --without syslog
...
# rpmbuild -ta glusterfs-3.6.7.tar.gz --without bd
...
# rpmbuild -ta glusterfs-3.6.7.tar.gz --without qemu-block
...
%else
Source0:          glusterfs-3.6.7.tar.gz
%endif
